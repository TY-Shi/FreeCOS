...
tar_file = "D://Project_code//Generator_vessel//DRIVE_crop_refine//"
Save_image = "./fake_drivevessel_image_rota/"
Save_label = "./fake_drivevessel_label_rota/"
...
for i in range(len(files_src)):
    tarlist = random.sample(files_tar, 20)
    for j in range(len(tarlist)):
        ...
        src_in_trg = im_src.transpose((1,2,0))

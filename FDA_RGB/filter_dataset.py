...
src_file = "D://Project_code//Generator_vessel//make_fake_vessel_code//FDA_RGB//FDA_retinalIOSTAR_rgbimage//"
label_file = "D://Project_code//Generator_vessel//make_fake_vessel_code//FDA_RGB//FDA_retinalIOSTAR_rgblabel//"
Save_image = "./FDA_IOSTAR_filter_rgbimage/"
Save_label = "./FDA_IOSTAR_filter_rgblabel/"
...
for i in range(len(files_src)):
    ...
    Image.fromarray((img).astype('uint8')).convert('RGB').save(save_image_path)
